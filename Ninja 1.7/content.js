 (() => {
   ...
   console.log("[Ninja Downloader] content.js loaded ✅ (v1.7 ClassDojo Downloads + range filtering)");
   ...
   // 🔄 Send download requests to background.js
   ...
   async function downloadOne(att, fromYMD, toYMD, i, total) {
     ...
     if (date < fromYMD || date > toYMD) return; // ✅ skip if outside range
